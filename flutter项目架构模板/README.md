...
![flutter_moban.gif](https://ss.im5i.com/2021/06/14/62BOO.gif)
...
```
git clone https://github.com/xuexiangjys/flutter_moban.git
```
...
最简单的替换方法就是进行全局替换,搜索关键字`flutter_moban`,然后替换你想要的项目包名,如下图所示:
